...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("nhan_dang_trai_cay-main/yolov8n_trai_cay.onnx")
    print(st.session_state["LoadModel"])
    print('Load model lần đầu') 

filename_classes = 'nhan_dang_trai_cay-main/object_detection_trai_cay_yolo.txt'
mywidth  = 640
myheight = 640
